   ...
   for ll = 1 : n_int
     ...
     for aa = 1:n_en
         ...
         for bb = 1:n_en
             ...
             DBb = [D_tilde(1,1) * Nb_x, D_tilde(1,2) * Nb_y, D_tilde(1,3) * Nb_z;
                    D_tilde(1,2) * Nb_x, D_tilde(2,2) * Nb_y, D_tilde(2,3) * Nb_z;
                    D_tilde(1,3) * Nb_x, D_tilde(2,3) * Nb_y, D_tilde(3,3) * Nb_z;
                    0,                   D_tilde(4,4) * Nb_z, D_tilde(4,4) * Nb_y;
                    D_tilde(5,5) * Nb_z, 0,                   D_tilde(5,5) * Nb_x;
                    D_tilde(6,6) * Nb_y, D_tilde(6,6) * Nb_x, 0];

             k_ele(n_ed * (aa - 1) + 1, n_ed * (bb - 1) + 1) = k_ele(n_ed * (aa - 1) + 1, n_ed * (bb - 1) + 1) + Na_x * DBb(1,1) + Na_z * DBb(5,1) + Na_y * DBb(6,1);
             k_ele(n_ed * (aa - 1) + 1, n_ed * (bb - 1) + 2) = k_ele(n_ed * (aa - 1) + 1, n_ed * (bb - 1) + 2) + Na_x * DBb(1,2) + Na_y * DBb(6,2);
             k_ele(n_ed * (aa - 1) + 1, n_ed * (bb - 1) + 3) = k_ele(n_ed * (aa - 1) + 1, n_ed * (bb - 1) + 3) + Na_x * DBb(1,3) + Na_z * DBb(5,3);

             k_ele(n_ed * (aa - 1) + 2, n_ed * (bb - 1) + 1) = k_ele(n_ed * (aa - 1) + 2, n_ed * (bb - 1) + 1) + Na_y * DBb(2,1) + Na_x * DBb(6,1);
             k_ele(n_ed * (aa - 1) + 2, n_ed * (bb - 1) + 2) = k_ele(n_ed * (aa - 1) + 2, n_ed * (bb - 1) + 2) + Na_y * DBb(2,2) + Na_z * DBb(4,2) + Na_x * DBb(6,2);
             k_ele(n_ed * (aa - 1) + 2, n_ed * (bb - 1) + 3) = k_ele(n_ed * (aa - 1) + 2, n_ed * (bb - 1) + 3) + Na_y * DBb(2,3) + Na_z * DBb(4,3);

             k_ele(n_ed * (aa - 1) + 3, n_ed * (bb - 1) + 1) = k_ele(n_ed * (aa - 1) + 3, n_ed * (bb - 1) + 1) + Na_z * DBb(3,1) + Na_x * DBb(5,1);
             k_ele(n_ed * (aa - 1) + 3, n_ed * (bb - 1) + 2) = k_ele(n_ed * (aa - 1) + 3, n_ed * (bb - 1) + 2) + Na_z * DBb(3,2) + Na_y * DBb(4,2);
             k_ele(n_ed * (aa - 1) + 3, n_ed * (bb - 1) + 3) = k_ele(n_ed * (aa - 1) + 3, n_ed * (bb - 1) + 3) + Na_z * DBb(3,3) + Na_y * DBb(4,3) + Na_x * DBb(5,3);
         end
     end
