...
n_en = 27; % number of  element nodes
n_ed = 1; % number of element degrees of freedom (per node)

deg_xi = 2;   % degree of lagrange polynomial in xi-direction
deg_eta = 2;  % degree of lagrange polynomial in eta-direction
deg_zeta = 2;  % degree of lagrange polynomial in zeta-direction
...
n_int_xi = 6; n_int_eta = 6; n_int_zeta = 6;
...
% triquadratic Hexahedral element
...
for ez = 1 : n_el_z
    for ey = 1 : n_el_y
        for ex = 1:n_el_x
            ...
            IEN(1,ee) = (deg_zeta * ez - 2) * n_np_x * n_np_y + (deg_eta * ey - 2)* n_np_x + deg_xi * (ex - 1) + 1;
            IEN(2,ee) = (deg_zeta * ez - 2) * n_np_x * n_np_y + (deg_eta * ey - 2)* n_np_x + deg_xi * (ex - 1) + 3;
            IEN(3,ee) = (deg_zeta * ez - 2) * n_np_x * n_np_y +  deg_eta * ey     * n_np_x + deg_xi * (ex - 1) + 3;
            IEN(4,ee) = (deg_zeta * ez - 2) * n_np_x * n_np_y +  deg_eta * ey     * n_np_x + deg_xi * (ex - 1) + 1;
            IEN(5,ee) =  deg_zeta * ez      * n_np_x * n_np_y + (deg_eta * ey - 2)* n_np_x + deg_xi * (ex - 1) + 1;
            IEN(6,ee) =  deg_zeta * ez      * n_np_x * n_np_y + (deg_eta * ey - 2)* n_np_x + deg_xi * (ex - 1) + 3;
            IEN(7,ee) =  deg_zeta * ez      * n_np_x * n_np_y +  deg_eta * ey     * n_np_x + deg_xi * (ex - 1) + 3;
            IEN(8,ee) =  deg_zeta * ez      * n_np_x * n_np_y +  deg_eta * ey     * n_np_x + deg_xi * (ex - 1) + 1;

            IEN(9,ee) = (deg_zeta * ez - 2) * n_np_x * n_np_y + (deg_eta * ey - 2)* n_np_x + deg_xi * (ex - 1) + 2;
            IEN(10,ee)= (deg_zeta * ez - 2) * n_np_x * n_np_y + (deg_eta * ey - 1)* n_np_x + deg_xi * (ex - 1) + 3;
            IEN(11,ee)= (deg_zeta * ez - 2) * n_np_x * n_np_y +  deg_eta * ey     * n_np_x + deg_xi * (ex - 1) + 2;
            IEN(12,ee)= (deg_zeta * ez - 2) * n_np_x * n_np_y + (deg_eta * ey - 1)* n_np_x + deg_xi * (ex - 1) + 1;
            IEN(13,ee)=  deg_zeta * ez      * n_np_x * n_np_y + (deg_eta * ey - 2)* n_np_x + deg_xi * (ex - 1) + 2;
            IEN(14,ee)=  deg_zeta * ez      * n_np_x * n_np_y + (deg_eta * ey - 1)* n_np_x + deg_xi * (ex - 1) + 3;
            IEN(15,ee)=  deg_zeta * ez      * n_np_x * n_np_y +  deg_eta * ey     * n_np_x + deg_xi * (ex - 1) + 2;
            IEN(16,ee)=  deg_zeta * ez      * n_np_x * n_np_y + (deg_eta * ey - 1)* n_np_x + deg_xi * (ex - 1) + 1;

            IEN(17,ee)= (deg_zeta * ez - 1) * n_np_x * n_np_y + (deg_eta * ey - 2)* n_np_x + deg_xi * (ex - 1) + 1;
            IEN(18,ee)= (deg_zeta * ez - 1) * n_np_x * n_np_y + (deg_eta * ey - 2)* n_np_x + deg_xi * (ex - 1) + 3;
            IEN(19,ee)= (deg_zeta * ez - 1) * n_np_x * n_np_y +  deg_eta * ey     * n_np_x + deg_xi * (ex - 1) + 3;
            IEN(20,ee)= (deg_zeta * ez - 1) * n_np_x * n_np_y +  deg_eta * ey     * n_np_x + deg_xi * (ex - 1) + 1;

            IEN(21,ee)= (deg_zeta * ez - 2) * n_np_x * n_np_y + (deg_eta * ey - 1)* n_np_x + deg_xi * (ex - 1) + 2;
            IEN(22,ee)=  deg_zeta * ez      * n_np_x * n_np_y + (deg_eta * ey - 1)* n_np_x + deg_xi * (ex - 1) + 2;
            IEN(23,ee)= (deg_zeta * ez - 1) * n_np_x * n_np_y + (deg_eta * ey - 2)* n_np_x + deg_xi * (ex - 1) + 2;
            IEN(24,ee)= (deg_zeta * ez - 1) * n_np_x * n_np_y +  deg_eta * ey     * n_np_x + deg_xi * (ex - 1) + 2;
            IEN(25,ee)= (deg_zeta * ez - 1) * n_np_x * n_np_y + (deg_eta * ey - 1)* n_np_x + deg_xi * (ex - 1) + 1;
            IEN(26,ee)= (deg_zeta * ez - 1) * n_np_x * n_np_y + (deg_eta * ey - 1)* n_np_x + deg_xi * (ex - 1) + 3;
            IEN(27,ee)= (deg_zeta * ez - 1) * n_np_x * n_np_y + (deg_eta * ey - 1)* n_np_x + deg_xi * (ex - 1) + 2;
        end
    end
end
