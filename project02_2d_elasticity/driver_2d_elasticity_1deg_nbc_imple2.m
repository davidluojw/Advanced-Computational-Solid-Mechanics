   ...
   for ll = 1 : n_int
     ...
     for aa = 1 : n_en
         ...
         for bb = 1 : n_en
             ...
             DBb = [D_tilde(1,1) * Nb_x, D_tilde(1,2) * Nb_y;
                    D_tilde(1,2) * Nb_x, D_tilde(2,2) * Nb_y;
                    D_tilde(3,3) * Nb_y, D_tilde(3,3) * Nb_x];

             
             k_ele(n_ed * (aa - 1) + 1, n_ed * (bb - 1) + 1) = k_ele(n_ed * (aa - 1) + 1, n_ed * (bb - 1) + 1) + Na_x * DBb(1,1) + Na_y * DBb(3,1);
             k_ele(n_ed * (aa - 1) + 1, n_ed * (bb - 1) + 2) = k_ele(n_ed * (aa - 1) + 1, n_ed * (bb - 1) + 2) + Na_x * DBb(1,2) + Na_y * DBb(3,2);
             k_ele(n_ed * (aa - 1) + 2, n_ed * (bb - 1) + 1) = k_ele(n_ed * (aa - 1) + 2, n_ed * (bb - 1) + 1) + Na_y * DBb(2,1) + Na_x * DBb(3,1);
             k_ele(n_ed * (aa - 1) + 2, n_ed * (bb - 1) + 2) = k_ele(n_ed * (aa - 1) + 2, n_ed * (bb - 1) + 2) + Na_y * DBb(2,2) + Na_x * DBb(3,2);
