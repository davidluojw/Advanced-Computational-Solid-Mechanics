function epsilon = elemStrain(x_coor, y_coor, disp, deltadisp, AA, PP, Rigidrot)
    % element dofs
    ...
    epsilon = [ du_dx + 0.5 * du_dx * du_dx + 0.5 * dv_dx * dv_dx;  % consider the Green-Lagrangian strain
